...
/**
 * The ItemsRepository maintains an in-memory array of items
 * The Repository methods interact with this array to perform CRUD operations
 *
 * ItemsRepository represents a class which directly interfaces
 * w/ the DB and performs CRUD operations on it
 *
 * The Repository Design Pattern is used as the Data Access Layer
 */
export class ItemsRepositoryInMem implements IItemsRepository {
  // In-Memory Database
  #items: ItemWithId[] = [
    {
